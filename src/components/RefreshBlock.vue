...
const loadData = () => {
   ...
   makeRequest({ method: 'GET', url: 'prod/getContent' })
      .then((res) => {
...
<template>
   ...
   <div v-if="layout === 'horizontal'">
      <div
         class="horizontal-main"
         :style="{ padding: padding, borderRadius: borderRadius, boxShadow: boxShadow }"
      >
         ...
         <div class="refresh-button-block">
            <button class="refresh-button" @click="loadData()">Refresh</button>
   ...
   <div v-if="layout === 'vertical'">
      ...
      >
         ...
         <button class="vertical-refresh-button" @click="loadData()">Refresh</button>
